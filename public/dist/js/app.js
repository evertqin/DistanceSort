...
var MapDisplay = function (_React$Component2) {
    ...
    function MapDisplay(props) {
        ...
        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(MapDisplay).call(this, props));

        _this2.directionsDisplay = [];
        return _this2;
    }
...
var TextBoxControl = function (_React$Component3) {
    ...
    function TextBoxControl(props) {
        ...
        _this4.handleTravelMethodChange = _this4.handleTravelMethodChange.bind(_this4);
    ...
    _createClass(TextBoxControl, [{
        ...
        key: 'handleTravelMethodChange',
        value: function handleTravelMethodChange(e) {
            everythingIsFine();
            this.setState({
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'form-group travel-method' },
                    React.createElement(
                        'label',
                        { htmlFor: 'methodInput' },
                        'Travel Method'
                    ...
                    React.createElement(
                        'select',
                        { value: this.state.TravelMethod, onChange: this.handleTravelMethodChange },
                        function () {
                            var items = [];

                            for (var key in _enums.TravelMethods) {
                                items.push(React.createElement(
                                    'option',
                                    { key: key, type: 'radio', value: key },
                                    key
                                ));
                            }
                            return items;
...
var ResultList = function (_React$Component4) {
    ...
    _createClass(ResultList, [{
        ...
        key: 'render',
        value: function render() {
            var list = this.state.data.map(function (entry, index) {
                return React.createElement(
                    'tr',
            ...
            if (this.state.status === 'running') {
                ...
                return React.createElement(
                    'table',
                    { className: 'table table-bordered addressArea' },
                    React.createElement(
                        'thead',
                        null,
                        React.createElement(
...
},{"./constants/enums":161,"./directions":162,"react":159}],161:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.TravelMethods = undefined;
...
var TravelMethods = exports.TravelMethods = {
	'DRIVING': 'fa-car',
	'WALKING': 'fa-subway',
...
},{"keyMirror":28}],162:[function(require,module,exports){
...
var Direction = function () {
	function Direction(directionsService, origin, dests, travelMode) {
	...
	_createClass(Direction, [{
		...
		key: 'calcAll',
		value: function calcAll(allDoneCallback) {
			var result = [];
			var count = 0;
...
},{"./component":160,"react":159,"react-dom":30}]},{},[163])
